globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { version, ref, watchEffect, watch, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, toRef, isRef, hasInjectionContext, unref, inject, useSSRContext, createApp, effectScope, reactive, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, defineAsyncComponent, shallowRef, shallowReactive, isReadonly, computed, withCtx, isShallow, isReactive, toRaw, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
}
{
  let applyHMR = function(newConfig) {
    ...
    if (newConfig && appConfig2) {
      deepAssign(appConfig2, newConfig);
      deepDelete(appConfig2, newConfig);
    }
  };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-e1ff3ec4.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-95c8f033.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-viewpost",
    path: "/blog/viewpost",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/viewpost-4d2a4ff0.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a4a13d23.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-3189c805.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-d0e18e8a.mjs').then((m) => m.default || m)
};
...
const __nuxt_component_0 = /* @__PURE__ */ defineComponent({
  ...
  setup(props, context) {
    ...
    return () => {
      ...
      if (layout.value && !hasLayout && layout.value !== "default") {
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__file", "/home/karl/carl/git/portfolio/node_modules/nuxt/dist/pages/runtime/app.vue"]]);
const _sfc_main$1 = {
  __name: "error",
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-sm mx-auto text-center mt-7 card" }, _attrs))}><p class="font-bold mt-7 text-7xl">${ssrInterpolate(__props.error.statusCode)}</p><p class="text-5xl mt-7">Ooops..</p><p class="mt-7">${ssrInterpolate(__props.error.message)}</p><button class="btn my-7">Go Home...</button></div>`);
    };
  }
};
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "/home/karl/carl/git/portfolio/error.vue"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/karl/carl/git/portfolio/node_modules/nuxt/dist/app/components/nuxt-root.vue"]]);
if (!globalThis.$fetch) {
...
export { _export_sfc as _, useRouter as a, navigateTo as b, createError as c, useAppConfig as d, entry$1 as default, appConfig as e, useState as f, mergeConfig as m, nuxtLinkDefaults as n, useHead as u };
