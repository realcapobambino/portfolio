...
<script setup>
import { ref } from 'vue';
import { Twitter, Linkedin, Instagram, Github } from 'lucide-vue-next'

const socialMediaLinks = ref({
    twitter: 'https://twitter.com/realcapobambino',
    instagram: 'https://www.instagram.com/realcapobambino/',
    linkedin: 'https://www.linkedin.com/in/charleswahome/',
    github: 'https://github.com/realcapobambino',
    ...
    <footer class="bottom-0 flex flex-col items-center w-full text-center dark-mode-text">
        <div class="px-6 pt-6 ">
            <div class="flex justify-center mb-6">
                <a v-for="(link, platform) in socialMediaLinks" :key="platform" :href="link" type="button"
                    class="m-2 uppercase transition duration-300 ease-in-out border-2 rounded-2xl text-red h-9 w-9 border-primary"
                    data-te-ripple-init data-te-ripple-color="light">
                    <component :is="getSocialMediaIcon(platform)" class="m-1 text-center dark-mode-text" />
                </a>
            </div>
        </div>
        ...
        <div class="flex justify-center w-full p-2 m-2">
            ...
            <svg viewBox="0 0 128 128" class="w-8 h-8">
                ...
                <path fill="#35495e" d="M31.404.394L51.133.4l12.896 21.407L76.88.403 96.592.398 64.128 56.71z"></path>
                <path fill="#41b883" d="M9.887.544l21.5-.146 32.722 56.315L96.575.401l21.537.023-54.007 92.684z"></path>
            </svg>
