...
<template>
    <div class="px-4 mx-auto mt-8 overflow-y-scroll md:container" id="about">
            ...
            <div class="mt-6 lg:w-1/2 lg:pr-4 lg:mt-0">
                ...
                <div class="dark-mode-text">
                    <p class="p-2 mt-4 font-ShortStack">
                        ...
                        intricacies of security to ensure robust and reliable systems.
                    </p>
                </div>
            </div>
                        ...
                        <div class="px-6 pt-6 ">
                            <div class="flex justify-start mb-6">
                                <a v-for="(link, platform) in socialMediaLinks" :key="platform" :href="link" type="button"
                                    class="m-2 text-white uppercase transition duration-150 ease-in-out border-2 rounded-full border-primary h-9 w-9 hover:scale- hover:bg-opacity-5 focus:outline-none focus:ring-0"
                                    data-te-ripple-init data-te-ripple-color="light">
                                    <component :is="getSocialMediaIcon(platform)" class="m-1 dark-mode-text" />
                                </a>
                            </div>
                        </div>
                    </div>
